...
### Slide 1 — Tiêu đề
**🖥 Hiển thị:** Tên đề tài; badge **"Chuyên đề Nghiên cứu Tổng quan · Khoa Công nghệ Thông tin · Trường Đại học Tôn Đức Thắng · 2026"**; logo (góc phải-trên), tên học viên + GVHD, "Proposal Defense".
...
### Slide 2 — Mục lục
**🖥 Hiển thị:** 8 phần chia 2 cột (1–4 trái · 5–8 phải); phần **4 "Nội dung & Phương pháp"** tô cam = trọng tâm.
**🔍 Giải thích:** Khung toàn bài: (1) Giới thiệu & bài toán → (2) Mục tiêu & giả thuyết → (3) Lược khảo → (4) Nội dung & phương pháp [trọng tâm] → (5) Giới hạn → (6) Kết quả & thụ hưởng → (7) Kinh phí & kế hoạch → (8) Kết luận & phụ lục.
**📚 Tham khảo:** —
...
### Slide 7 — Câu hỏi / Giả thuyết nghiên cứu
...
## PHẦN 2 — LƯỢC KHẢO TÀI LIỆU (Slide 8–16)

### Slide 8 — Lược khảo (1/9): Survey arc 2024→2026
...
### Slide 9 — Lược khảo (2/9): Internal → External
...
### Slide 10 — Lược khảo (3/9): Quên là quy luật + replay
...
### Slide 11 — Lược khảo (4/9): PEFT/LoRA + O-LoRA
...
### Slide 12 — Lược khảo (5/9): CPT scaling + D-CPT Law
...
### Slide 13 — Lược khảo (6/9): ReGrad (đối chiếu)
...
### Slide 14 — Lược khảo (7/9): RAG memory & unlearning
...
### Slide 15 — Lược khảo (8/9): Dữ liệu luật VN + reasoning gap
...
### Slide 16 — Lược khảo (9/9): Bốn khoảng trống
...
## PHẦN 3 — NỘI DUNG & PHƯƠNG PHÁP (Slide 17–28)

### Slide 17 — Nội dung nghiên cứu (3 Work Package)
...
### Slide 19 — RAG cho vào đâu trong pipeline?
...
### Slide 21 — Đơn vị tri thức & metadata
...
### Slide 22 — Selective Memory (cơ chế)
...
### Slide 24 — (Phụ) Unlearning: xóa ≠ quên
...
### Slide 26 — Module 3: LoRA + mô hình nhỏ
...
### Slide 27 — Phương pháp luận dữ liệu + so sánh 4 arm
**🖥 Hiển thị:** Quy trình Collection→Sampling→Analysis + bảng so sánh 4 arm.
**🔍 Giải thích từng ô:**
- **Collection:** crawl + metadata + LLM tự kiểm + spot-check 5%.
...
### Slide 28 — Giới hạn phạm vi (Where & When)
...
## PHẦN 4 — KẾT QUẢ, KẾ HOẠCH & KẾT LUẬN (Slide 29–35)

### Slide 29 — Kết quả mong đợi (R1–R3)
...
### Slide 30 — Đối tượng thụ hưởng (Who)
...
### Slide 31 — Kinh phí & lộ trình (How much)
...
### Slide 34 — (Phụ lục) Q&A 1: "Em nghiên cứu gì mới?"
...
### Slide 35 — (Phụ lục) Q&A 2: Mô hình nhỏ & khả thi
**🖥 Hiển thị:** Câu hỏi + 3 điểm trả lời.
**🔍 Giải thích từng ô:**
...
## PHẦN PHỤ LỤC — SƠ ĐỒ CHI TIẾT (Slide 36–38)

### Slide 36 — (Phụ lục) Fig 3.2 · Luồng vận hành hệ thống
...
**🔍 Giải thích:** P (lọc *tài liệu*, bước ③) khác Q (ràng buộc *sinh*, bước ⑤); base đóng băng, cập nhật ở tầng KB chứ không đụng trọng số.
**📚 Tham khảo:** —
...
### Slide 37 — (Phụ lục) Fig 3.3 · Pipeline phương pháp dữ liệu
**🖥 Hiển thị:** 4 chặng Thu thập → Xử lý/Chỉ mục → Lấy mẫu → Phân tích; nhánh nét đứt "LLM tự kiểm trước · spot-check 5% metadata".
**🔍 Giải thích:** Mỗi cách chia mẫu phục vụ một giả thuyết/rủi ro cụ thể; toàn bộ pipeline để kiểm định H1–H4.
**📚 Tham khảo:** —
...
### Slide 38 — (Phụ lục) Fig 4.1 · Phụ thuộc ba Work Package
